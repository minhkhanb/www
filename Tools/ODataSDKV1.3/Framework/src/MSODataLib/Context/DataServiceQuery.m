...
- (QueryOperationResponse*) execute:(NSString*) aQuery
{
    ...
    //NSLog(@"\nPine debug query = %@", query);
    //NSMutableDictionary* hearder = [[NSMutableDictionary alloc] init];
    //[hearder setObject:@"Basic YWRtaW46MFJhYVlBLzc0UHU5TUVpbURUUGtpV1UyU0RHZG5EMlZteEljMkhRM3VkQT0=" forKey:@"Authorization"];
