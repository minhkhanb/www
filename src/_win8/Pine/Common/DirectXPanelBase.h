...
#pragma once
#include "pch.h"
#include "../Src/ServerStream/ServerStream.h"
//#include <concrt.h>

namespace Pine
{
	public delegate void DelegateProcessRequest(UINT32 constructor_id);
    ...
    {
	public:
		event DelegateProcessRequest^ OnRequest;
		void ServiceRequest(int request_id);
		property int CurrentError;
		
    protected private:
		bool m_create_device_success;
        DirectXPanelBase();
