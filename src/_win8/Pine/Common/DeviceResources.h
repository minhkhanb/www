...
namespace DX
{
	...
	public:
		...
		ID3D11DepthStencilState* GetDepthStencilState() const			{ return m_depthDisabledStencilState.Get(); }
		ID3D11RasterizerState*	GetRasterizerState() const				{ return m_rasterState.Get(); }
