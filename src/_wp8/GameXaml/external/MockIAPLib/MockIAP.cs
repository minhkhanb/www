...
namespace MockIAPLib
{
    public static class MockIAP
    {
        ...
        public static Dictionary<string, ProductListing> allProducts = new Dictionary<string,ProductListing>();
        ...
        private static void LoadListComplete(object sender, DownloadStringCompletedEventArgs e)
        {
            if (e.Error == null && e.Cancelled == false)
            {
                string rs = (string)e.Result;
                PopulateIAPItemsFromXml(rs);
