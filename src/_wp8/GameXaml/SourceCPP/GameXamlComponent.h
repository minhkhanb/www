...
public delegate void RequestBaseService(UINT32 constructor_id, UINT32 data_len);
...
public:
	...
	event RequestBaseService^ OnRequestBaseService;

	property Windows::Foundation::Size WindowBounds;
	property Windows::Foundation::Size NativeResolution;
	property Windows::Foundation::Size RenderResolution;
	void CallBaseService(UINT32 constructor_id, UINT32 data_len);
	bool OnBackKeyPress();
	void OnOrientationChange(int ori);
