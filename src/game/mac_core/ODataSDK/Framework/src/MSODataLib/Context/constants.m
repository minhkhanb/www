...
NSString* const Resource_Content_Type_ATOM						= @"application/atom+xml;charset=utf-8";//@"application/atom+xml,application/xml";
NSString* const Resource_Accept_JSON							= @"application/json";
NSString* const Resource_Content_Type_JSON						= @"application/json";
