...
void PineCanvas::putResource(Buffer* buff, int w, int h)
{
	...
	{
		//create new tex
		space_rect = { 0, 0, _tex_size.W, _tex_size.H };
	...
	_g->updateTexture(chr->_tex, buff->Data(), w, h, space_rect.X, space_rect.Y, PineColorFormat::RGBA_1BYTE);
